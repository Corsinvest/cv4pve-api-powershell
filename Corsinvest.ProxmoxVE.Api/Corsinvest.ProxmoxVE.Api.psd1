...
FunctionsToExport = 'Build-PveDocumentation', 'Connect-PveCluster',
               ...
               'Get-PveNodesCephPools', 'Get-PveNodesCephPoolsIdx',
               ...
               'Get-PveVersion', 'Get-PveVM', 'Get-PveVMSnapshots',
               'Invoke-PveRestApi', 'New-PveAccessDomains',
               'New-PveAccessDomainsSync', 'New-PveAccessGroups',
               'New-PveAccessOpenidAuthUrl', 'New-PveAccessOpenidLogin',
               'New-PveAccessRoles', 'New-PveAccessTfa', 'New-PveAccessTfaIdx',
...
AliasesToExport = 'Backup-PveVzdump', 'Copy-PveLxc', 'Copy-PveQemu', 'Get-PveTasksStatus',
               ...
               'Resume-PveLxc', 'Resume-PveQemu', 'Show-PveSpice', 'Start-PveLxc',
               'Start-PveQemu', 'Stop-PveLxc', 'Stop-PveQemu', 'Suspend-PveLxc',
               'Suspend-PveQemu', 'Update-PveNode'
