...
@{
    ...
    'Get-PveClusterStatus', 'Get-PveClusterTasks', 'Get-PveNodes',
    'Get-PveNodesAplinfo', 'Get-PveNodesApt', 'Get-PveNodesAptChangelog',
    'Get-PveNodesAptUpdate', 'Get-PveNodesAptVersions',
    'Get-PveNodesCeph', 'Get-PveNodesCephConfig',
    'Get-PveNodesCephConfigdb', 'Get-PveNodesCephCrush',
    'Get-PveNodesCephDisks', 'Get-PveNodesCephFlags',
    'Get-PveNodesCephFs', 'Get-PveNodesCephLog', 'Get-PveNodesCephMds',
    'Get-PveNodesCephMgr', 'Get-PveNodesCephMon', 'Get-PveNodesCephOsd',
    'Get-PveNodesCephPools', 'Get-PveNodesCephRules',
    'Get-PveNodesCephStatus', 'Get-PveNodesCertificates',
    'Get-PveNodesCertificatesAcme', 'Get-PveNodesCertificatesInfo',
    'Get-PveNodesConfig', 'Get-PveNodesCpu', 'Get-PveNodesDisks',
    ...
    'Get-PveStorageIdx', 'Get-PveVersion', 'New-PveAccessDomains',
    'New-PveAccessDomainsSync', 'New-PveAccessGroups',
    'New-PveAccessRoles', 'New-PveAccessTfa', 'New-PveAccessTicket',
    'New-PveAccessUsers', 'New-PveAccessUsersToken',
    ...
    'Remove-PveAccessRoles', 'Remove-PveAccessUsers',
    ...
    'Set-PveNodesTime', 'Set-PvePools', 'Set-PveStorage',
    'Build-PveDocumentation', 'Connect-PveCluster',
    'ConvertFrom-PveUnixTime', 'ConvertTo-PveUnixTime', 'Find-PveVM'
    ...
    AliasesToExport   = 'Get-PveTasksStatus', 'Get-PveTop', 'Move-PveLxc', 'Move-PveQemu',
    'Reset-PveQemu', 'Resume-PveLxc', 'Resume-PveQemu', 'Start-PveLxc',
    'Start-PveQemu', 'Stop-PveLxc', 'Stop-PveQemu', 'Suspend-PveLxc',
    'Suspend-PveQemu'
