...
#>
    ...
    process {
        ...
        if($PSBoundParameters['Migratedfrom']) { $parameters['migratedfrom'] = $Migratedfrom }
        if($PSBoundParameters['OverruleShutdown']) { $parameters['overrule-shutdown'] = $OverruleShutdown }
        if($PSBoundParameters['Skiplock']) { $parameters['skiplock'] = $Skiplock }
        if($PSBoundParameters['Timeout']) { $parameters['timeout'] = $Timeout }
...
function Get-PveNodesStorageImportMetadata
{
<#
.DESCRIPTION
...
#>
    ...
    process {
        ...
        if($PSBoundParameters['Nftables']) { $parameters['nftables'] = $Nftables }
...
#>
    ...
    process {
        ...
        if($PSBoundParameters['SkipCertVerification']) { $parameters['skip-cert-verification'] = $SkipCertVerification }
...
#>
    ...
    Param(
        ...
        [Parameter(ValueFromPipelineByPropertyName)]
        [SecureString]$ConfirmationPassword,
    ...
    process {
        $parameters = @{}
        if($PSBoundParameters['ConfirmationPassword']) { $parameters['confirmation-password'] = (ConvertFrom-SecureString -SecureString $ConfirmationPassword -AsPlainText) }
        if($PSBoundParameters['Password']) { $parameters['password'] = (ConvertFrom-SecureString -SecureString $Password -AsPlainText) }
        if($PSBoundParameters['Userid']) { $parameters['userid'] = $Userid }
