...
```
Set-PveClusterSdnVnetsFirewallOptions [[-PveTicket] <PveTicket>] [[-Delete] <String>] [[-Digest] <String>]
 [[-Enable] <Boolean>] [[-LogLevelForward] <String>] [[-PolicyForward] <String>] [-Vnet] <String>
