...
```
Set-PveClusterHaResources [[-PveTicket] <PveTicket>] [[-AutoRebalance] <Boolean>] [[-Comment] <String>]
 [[-Delete] <String>] [[-Digest] <String>] [[-Failback] <Boolean>] [[-Group] <String>] [[-MaxRelocate] <Int32>]
