...
```
Set-PveClusterCephFlagsIdx [[-PveTicket] <PveTicket>] [-Flag] <String> [-Value] <Boolean>
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

## DESCRIPTION
Set or clear (unset) a specific Ceph flag.
Runs synchronously (unlike the bulk PUT /cluster/ceph/flags endpoint, which forks a worker task).
