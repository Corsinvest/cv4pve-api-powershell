...
```
Remove-PveNodesDisksLvmthin [[-PveTicket] <PveTicket>] [[-CleanupConfig] <Boolean>] [[-CleanupDisks] <Boolean>]
 [-Name] <String> [-Node] <String> [-VolumeGroup] <String> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
