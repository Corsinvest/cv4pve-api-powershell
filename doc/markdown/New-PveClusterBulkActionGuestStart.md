...
```
New-PveClusterBulkActionGuestStart [[-PveTicket] <PveTicket>] [[-MaxWorkers] <Int32>] [[-Maxworkers2] <Int32>]
 [[-Timeout] <Int32>] [[-Vms] <Array>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
