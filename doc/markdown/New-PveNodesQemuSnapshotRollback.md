...
```
New-PveNodesQemuSnapshotRollback [[-PveTicket] <PveTicket>] [-Node] <String> [-Snapname] <String>
 [[-Start] <Boolean>] [-Vmid] <Int32> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
