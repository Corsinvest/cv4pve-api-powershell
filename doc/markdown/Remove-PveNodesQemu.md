...
```
Remove-PveNodesQemu [[-PveTicket] <PveTicket>] [[-DestroyUnreferencedDisks] <Boolean>] [-Node] <String>
 [[-Purge] <Boolean>] [[-Skiplock] <Boolean>] [-Vmid] <Int32> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
