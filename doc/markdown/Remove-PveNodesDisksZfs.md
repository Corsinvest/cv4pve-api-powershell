...
```
Remove-PveNodesDisksZfs [[-PveTicket] <PveTicket>] [[-CleanupConfig] <Boolean>] [[-CleanupDisks] <Boolean>]
 [-Name] <String> [-Node] <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
