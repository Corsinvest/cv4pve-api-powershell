...
```
New-PveClusterMappingPci [[-PveTicket] <PveTicket>] [[-Description] <String>] [-Id] <String>
 [[-LiveMigrationCapable] <Boolean>] [-Map] <Array> [[-Mdev] <Boolean>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
