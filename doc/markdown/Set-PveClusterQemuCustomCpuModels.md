...
# Set-PveClusterQemuCustomCpuModels
...
```
Set-PveClusterQemuCustomCpuModels [[-PveTicket] <PveTicket>] [-Cputype] <String> [[-Delete] <String>]
 [[-Digest] <String>] [[-Flags] <String>] [[-GuestPhysBits] <Int32>] [[-Hidden] <Boolean>]
 [[-HvVendorId] <String>] [[-Level] <Int32>] [[-PhysBits] <String>] [[-ReportedModel] <String>]
