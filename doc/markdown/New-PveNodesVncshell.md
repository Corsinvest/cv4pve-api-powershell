...
```
New-PveNodesVncshell [[-PveTicket] <PveTicket>] [[-Cmd] <String>] [[-CmdOpts] <String>] [[-Height] <Int32>]
 [-Node] <String> [[-Websocket] <Boolean>] [[-Width] <Int32>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
