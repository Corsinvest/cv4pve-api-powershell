...
```
New-PveClusterSdnFabricsNode [[-PveTicket] <PveTicket>] [[-AllowedIps] <Array>] [[-Digest] <String>]
 [[-Endpoint] <String>] [-FabricId] <String> [-Interfaces] <Array> [[-Ip] <String>] [[-Ip6] <String>]
 [[-LockToken] <String>] [-NodeId] <String> [[-Peers] <Array>] [-Protocol] <String> [[-PublicKey] <String>]
 [[-Role] <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
