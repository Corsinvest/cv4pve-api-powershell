...
```
Remove-PveNodesLxc [[-PveTicket] <PveTicket>] [[-DestroyUnreferencedDisks] <Boolean>] [[-Force] <Boolean>]
 [-Node] <String> [[-Purge] <Boolean>] [-Vmid] <Int32> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
