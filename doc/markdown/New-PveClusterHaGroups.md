...
```
New-PveClusterHaGroups [[-PveTicket] <PveTicket>] [[-Comment] <String>] [-Group] <String> [-Nodes] <String>
 [[-Nofailback] <Boolean>] [[-Restricted] <Boolean>] [[-Type] <String>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
