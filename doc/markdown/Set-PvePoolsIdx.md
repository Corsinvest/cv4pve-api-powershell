...
```
Set-PvePoolsIdx [[-PveTicket] <PveTicket>] [[-AllowMove] <Boolean>] [[-Comment] <String>] [[-Delete] <Boolean>]
 [-Poolid] <String> [[-Storage] <String>] [[-Vms] <String>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
