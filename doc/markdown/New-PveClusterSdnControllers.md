...
```
New-PveClusterSdnControllers [[-PveTicket] <PveTicket>] [[-Asn] <Int32>] [[-BgpMode] <String>]
 [[-BgpMultipathAsPathRelax] <Boolean>] [-Controller] <String> [[-Ebgp] <Boolean>] [[-EbgpMultihop] <Int32>]
 [[-Fabric] <String>] [[-IsisDomain] <String>] [[-IsisIfaces] <String>] [[-IsisNet] <String>]
 [[-LockToken] <String>] [[-Loopback] <String>] [[-Node] <String>] [[-Nodes] <String>]
 [[-PeerGroupName] <String>] [[-Peers] <String>] [[-RouteMapIn] <String>] [[-RouteMapOut] <String>]
